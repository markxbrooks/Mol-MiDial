...
class MIDIController:
    ...
    def __init__(self, main_window=None):
        ...
        if not MIDI_AVAILABLE:
            log.warning("⚠️ MIDI libraries not available. Install mido and rtmidi for MIDI support.")
    
    def _setup_default_mappings(self):
        """Set up default MIDI control mappings"""
        # Camera controls
        self.add_mapping("zoom", MIDIMapping(
        ...
        self.add_mapping("rotation_x", MIDIMapping(
            control_number=2,
            channel=0,
            control_type=MIDIControlType.KNOB,
        ...
        self.add_mapping("rotation_y", MIDIMapping(
            control_number=3,
            channel=0,
            control_type=MIDIControlType.KNOB,
        ...
        self.add_mapping("rotation_z", MIDIMapping(
            control_number=4,
            channel=0,
            control_type=MIDIControlType.KNOB,
        ...
        self.add_mapping("translate_x", MIDIMapping(
            control_number=5,
            channel=0,
        ...
        self.add_mapping("translate_y", MIDIMapping(
            control_number=6,
            channel=0,
            control_type=MIDIControlType.FADER,
        ...
        self.add_mapping("connolly_transparency", MIDIMapping(
            control_number=7,
            channel=0,
            control_type=MIDIControlType.KNOB,
        ...
        self.add_mapping("connolly_probe_radius", MIDIMapping(
            control_number=8,
            channel=0,
            control_type=MIDIControlType.KNOB,
        ...
        # Fog controls
        self.add_mapping("fog_density", MIDIMapping(
            control_number=9,
            channel=0,
            control_type=MIDIControlType.KNOB,
        ...
        self.add_mapping("fog_near", MIDIMapping(
            control_number=11,
            channel=0,
            control_type=MIDIControlType.KNOB,
        ...
        self.add_mapping("fog_far", MIDIMapping(
            control_number=12,
            channel=0,
            control_type=MIDIControlType.KNOB,
        ...
        # Clipping controls
        self.add_mapping("clip_z", MIDIMapping(
            control_number=13,
            channel=0,
            control_type=MIDIControlType.KNOB,
        ...
        self.add_mapping("clip_depth", MIDIMapping(
            control_number=14,
            channel=0,
            control_type=MIDIControlType.KNOB,
        ...
        # Isosurface controls
        self.add_mapping("isosurface_level", MIDIMapping(
            control_number=10,
            channel=0,
            control_type=MIDIControlType.KNOB,
    ...
    def _handle_control_change(self, msg):
        ...
        for name, mapping in self.mappings.items():
            if (mapping.control_number == control_number and 
                mapping.channel == channel and 
                mapping.enabled):
                ...
                log.debug(f"🎛️ MIDI Control: {name} -> {mapping.target_function} = {target_value}")
                break
    ...
    def _convert_midi_value(self, midi_value: int, mapping: MIDIMapping) -> float:
        ...
        # Map to target range
        target_value = mapping.target_min + (normalized * (mapping.target_max - mapping.target_min))
    ...
    def _call_control_handler(self, function_name: str, value: float):
        ...
        if function_name in self._last_update_times:
            ...
            throttle_interval = self._expensive_controls.get(function_name, self._throttle_interval)
            ...
            if time_since_last < throttle_interval:
                ...
                log.debug(f"🎛️ Throttling {function_name} (last update {time_since_last:.3f}s ago)")
                return
    ...
    if main_window and hasattr(main_window, 'glmol'):
        ...
        def set_connolly_transparency(value):
            if hasattr(main_window, 'dynamic_model_tab_manager'):
                active_model_id = main_window.dynamic_model_tab_manager.get_active_model_id()
                if active_model_id:
                    widget = main_window.dynamic_model_tab_manager.get_model_view_widget(active_model_id)
        ...
        controller.set_control_handler("connolly_transparency", set_connolly_transparency)
        controller.set_control_handler("connolly_probe_radius", set_connolly_probe_radius)
